...
namespace LumiTempMVC.DAO
{
    public class EmpresaParceiraDAO
    {
        ...
        private SqlParameter[] CriaParametros(EmpresaParceiraViewModel empresa)
        {
            ...
            parametros[0] = new SqlParameter("CD_EMPR", empresa.cd_empr);               // Código da empresa
            ...
            parametros[5] = new SqlParameter("FK_CD_FUNC", empresa.fk_cd_func);         // Código do funcionário associado (chave estrangeira)
            return parametros;
        }
        ...
        public void Inserir(EmpresaParceiraViewModel empresa)
        {
            ...
            string sql = "INSERT INTO cadr_empr_parc (CD_EMPR, NM_EMPR, CEP_EMPR, CNPJ_EMPR, TELF_CONT_EMPR, FK_CD_FUNC) " +
                         "VALUES (@CD_EMPR, @NM_EMPR, @CEP_EMPR, @CNPJ_EMPR, @TELF_CONT_EMPR, @FK_CD_FUNC) ";
        ...
        public void Alterar(EmpresaParceiraViewModel empresa)
        {
            ...
            string sql =
                ...
                "FK_CD_FUNC=@FK_CD_FUNC " +          // Atualiza o código do funcionário associado
                "WHERE CD_EMPR = @CD_EMPR";          // Condição para identificar a empresa a ser alterada
        ...
        public void Excluir(int cd_empr)
        {
            // Define a query SQL para exclusão
            string sql = "DELETE cadr_empr_parc WHERE CD_EMPR = " + cd_empr;
        ...
        public EmpresaParceiraViewModel Consulta(int cd_empr)
        {
            // Define a query SQL para consulta de uma empresa pelo seu código
            string sql = "SELECT * FROM cadr_empr_parc WHERE CD_EMPR = " + cd_empr;
        ...
        public static EmpresaParceiraViewModel MontaModelEmpresa(DataRow registro)
        {
            ...
            empresa.cd_empr = Convert.ToInt32(registro["CD_EMPR"]);
            ...
            empresa.fk_cd_func = Convert.ToInt32(registro["FK_CD_FUNC"]);
        ...
        public List<EmpresaParceiraViewModel> Listagem()
        {
            ...
            string sql = "SELECT * FROM cadr_empr_parc ORDER BY CD_EMPR"; // Query SQL para selecionar e ordenar as empresas
            DataTable tabela = HelperDAO.ExecutaSelect(sql, null); // Executa a consulta
        ...
        public int ProximoId()
        {
            ...
            string sql = "SELECT ISNULL(MAX(CD_EMPR) +1, 1) AS 'MAIOR' FROM cadr_empr_parc";
            DataTable tabela = HelperDAO.ExecutaSelect(sql, null); // Executa a consulta
